...
1. 모델 선택: [2DPASS](https://github.com/yanx27/2DPASS)
   - 선택 이유:
     - 2D-3D 정보 활용   
     2DPASS는 학습 시 2D 이미지의 풍부한 시맨틱 정보(색상, 질감 등)를 3D 포인트 클라우드 분할에 활용하고, 반대로 3D의 기하학적 정보를 2D 분할에 활용하는 구조를 가집니다. 이는 LiDAR만으로는 식별이 어려운 객체를 카메라 정보로 보완할 수 있게 해줍니다.
...
<p align="center">
    <img src="fig/000327_edit.png" align="center" width="98%">
    <br>
